...
export class StudentService {
  ...
  addStudent(studentRequest:Student): Observable<Student> {
    ...
    return this.hhtpClient.post<Student>(this.baseApiUrl+'/students/add',addStudentRequest);
  }
  ...
  uploadImage(studentId:string,file:File): Observable<any> {
    ...
    return this.hhtpClient.post(this.baseApiUrl+'/students/'+studentId+'/upload-image',formData,{
      responseType: 'text'
    });
  }
